...
import VkAdminReleases from "@/views/admin/releases.tsx";
import VkAdminReleaseEdit from "@/views/admin/releaseEdit.tsx";
...
const AdminPagePanel = () => {
    ...
    return <View activePanel={activePanel}>
        ...
        <Panel id={AdminPanelMenu.releases}>
            <VkAdminReleases id={AdminPanelMenu.releases} to={setActivePanel}/>
        </Panel>
        <Panel id={AdminPanelMenu.editReleases}>
            <VkAdminReleaseEdit id={AdminPanelMenu.editReleases} to={setActivePanel}/>
        </Panel>
    </View>
}
const AdminPage = () => {
