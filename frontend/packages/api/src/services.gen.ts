...
import type { ReadSiteInfoApiV1SiteInfoGetResponse, ChangeSiteInfoApiV1SiteInfoPostData, ChangeSiteInfoApiV1SiteInfoPostResponse, GetPhotoListApiV1PhotosListGetResponse, AddPhotoApiV1PhotosPostData, AddPhotoApiV1PhotosPostResponse, DeletePhotoByIdApiV1PhotosPhotoIdDeleteData, DeletePhotoByIdApiV1PhotosPhotoIdDeleteResponse, GetPhotoFromIdApiV1PhotosPhotoIdGetData, GetPhotoFromIdApiV1PhotosPhotoIdGetResponse, ReleasesHandlerApiV1ReleasesGetData, ReleasesHandlerApiV1ReleasesGetResponse, ChangeReleaseHandlerApiV1ReleasesPostData, ChangeReleaseHandlerApiV1ReleasesPostResponse, DeleteReleaseHandlerApiV1ReleasesReleaseIdDeleteData, DeleteReleaseHandlerApiV1ReleasesReleaseIdDeleteResponse, VkidFirstStepApiV1VkidFirstStepPostResponse, VkidSecondStepApiV1VkidSecondStepPostData, VkidSecondStepApiV1VkidSecondStepPostResponse, VkidProfileApiV1VkidProfileGetResponse, VkidLogoutApiV1VkidLogoutPostResponse } from './types.gen';
...
/**
 * Change Release Handler
 * CHANGE CURRENT RELEASE
 * @param data The data for the request.
 * @param data.requestBody
 * @returns ReleasesInfoEdit Successful Response
 * @throws ApiError
 */
export const changeReleaseHandlerApiV1ReleasesPost = (data: ChangeReleaseHandlerApiV1ReleasesPostData): CancelablePromise<ChangeReleaseHandlerApiV1ReleasesPostResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/api/v1/releases/',
    body: data.requestBody,
    mediaType: 'application/json',
 ...
 * @param data The data for the request.
 * @param data.releaseId
 * @returns ReleasesInfoEdit Successful Response
 * @throws ApiError
 */
export const deleteReleaseHandlerApiV1ReleasesReleaseIdDelete = (data: DeleteReleaseHandlerApiV1ReleasesReleaseIdDeleteData): CancelablePromise<DeleteReleaseHandlerApiV1ReleasesReleaseIdDeleteResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
