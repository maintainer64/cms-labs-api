...
export type ChangeReleaseHandlerApiV1ReleasesPostData = {
    requestBody: ReleasesSchemaItem;
};

export type ChangeReleaseHandlerApiV1ReleasesPostResponse = (ReleasesInfoEdit);

export type DeleteReleaseHandlerApiV1ReleasesReleaseIdDeleteData = {
    releaseId: number;
};

export type DeleteReleaseHandlerApiV1ReleasesReleaseIdDeleteResponse = (ReleasesInfoEdit);
...
export type VkidProfileApiV1VkidProfileGetResponse = (JWTModelProfile);
