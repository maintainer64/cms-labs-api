...
-- +migrate Up
CREATE TABLE `{{.DB_TABLE_PREFIX}}curl_requests`
(
  `id`         bigint unsigned AUTO_INCREMENT,
  `created_at` datetime(3),
  `updated_at` datetime(3),
  `name`       varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `url`        varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `method`     varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `headers`    mediumblob,
  `body`       mediumblob,
  `timeout`    bigint,
  `raw`        mediumblob,
...
-- +migrate Down
drop table if exists `{{.DB_TABLE_PREFIX}}curl_requests` cascade;
