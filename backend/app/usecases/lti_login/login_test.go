...
func TestValidate(t *testing.T) {
	...
	r := httptest.NewRequest(fiber.MethodPost, "https://tool.tld/login", bytes.NewReader([]byte("")))
	...
	r = httptest.NewRequest(fiber.MethodPost, "https://tool.tld/login", bytes.NewReader(
...
func TestRedirectURI(t *testing.T) {
	...
	r := httptest.NewRequest(fiber.MethodPost, "https://tool.tld/login", bytes.NewReader(getPostBody()))
	r.Header.Set("Content-Type", "application/x-www-form-urlencoded")
