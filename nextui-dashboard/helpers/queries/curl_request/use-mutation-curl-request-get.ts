...
import {
  CoreJsonRpcPath,
  transportWithAuth,
  UsecasesCurlRequestGetRequest,
  UsecasesCurlRequestGetResponse
} from '@/helpers/api';
import { TMutationCustomOptions } from '@/helpers/queries/types';
import queryClient from '@/helpers/queries/base';
import { CamelCasedPropertiesDeep } from 'type-fest';

type Params = CamelCasedPropertiesDeep<UsecasesCurlRequestGetRequest['params']>;
type Response = CamelCasedPropertiesDeep<UsecasesCurlRequestGetResponse['result']>;

export const useMutationCurlRequestGet = (options: TMutationCustomOptions<Response, Params> = {}) => {
