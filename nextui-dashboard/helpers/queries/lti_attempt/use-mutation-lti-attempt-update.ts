...
import {
  CoreJsonRpcPath,
  transportWithAuth,
  UsecasesLTIAttemptEditRequest,
  UsecasesLTIAttemptEditResponse
} from '@/helpers/api';
import { TMutationCustomOptions } from '@/helpers/queries/types';
import queryClient from '@/helpers/queries/base';
import { CamelCasedPropertiesDeep } from 'type-fest';

type Params = CamelCasedPropertiesDeep<UsecasesLTIAttemptEditRequest['params']>;
type Response = CamelCasedPropertiesDeep<UsecasesLTIAttemptEditResponse['result']>;

export const useMutationLtiAttemptUpdate = (options: TMutationCustomOptions<Response, Params> = {}) => {
