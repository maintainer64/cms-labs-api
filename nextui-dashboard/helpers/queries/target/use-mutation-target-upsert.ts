...
import {
  CoreJsonRpcPath,
  transportWithAuth,
  UsecasesTargetUpsertRequest,
  UsecasesTargetUpsertResponse
} from '@/helpers/api';
import { TMutationCustomOptions } from '@/helpers/queries/types';
import queryClient from '@/helpers/queries/base';
import { CamelCasedPropertiesDeep } from 'type-fest';

type Params = CamelCasedPropertiesDeep<UsecasesTargetUpsertRequest['params']>;
type Response = CamelCasedPropertiesDeep<UsecasesTargetUpsertResponse['result']>;

export const useMutationTargetUpsert = (options: TMutationCustomOptions<Response, Params> = {}) => {
