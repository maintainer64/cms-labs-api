import {auth_SwaggerSSOToken, postV1TokenRenew} from './backend';
import {ApiRequestOptions} from '@/helpers/api/backend/core/ApiRequestOptions'; // Импортируем библиотеку для работы с JWT
const TokenManager = {
