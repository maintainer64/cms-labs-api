...
export const models_ServiceCardSchema = {
  type: 'object',
  required: ['created_at', 'description', 'image_url', 'name', 'updated_at', 'url'],
  properties: {
    created_at: {
      type: 'string'
    },
...
export const models_ServiceCardListItemSchema = {
  type: 'object',
  required: ['created_at', 'description', 'image_url', 'name', 'updated_at', 'url'],
  properties: {
    created_at: {
...
export const usecases_ServiceCardDeleteInputDTOSchema = {
  type: 'object',
  properties: {
    id: {
      type: 'integer'
...
export const usecases_ServiceCardDeleteResponseSchema = {
  type: 'object',
  required: ['error', 'msg'],
  properties: {
    error: {
...
export const usecases_ServiceCardEditOutputDTOSchema = {
  type: 'object',
  properties: {
    id: {
      type: 'integer'
...
export const usecases_ServiceCardEditResponseSchema = {
  type: 'object',
  required: ['error', 'msg'],
  properties: {
    error: {
...
export const usecases_ServiceCardGetInputDTOSchema = {
  type: 'object',
  properties: {
    id: {
      type: 'integer'
...
export const usecases_ServiceCardGetOutputDTOSchema = {
  type: 'object',
  properties: {
    model: {
...
export const usecases_ServiceCardGetResponseSchema = {
  type: 'object',
  required: ['error', 'msg'],
  properties: {
    error: {
...
export const usecases_ServiceCardListInputDTOSchema = {
  type: 'object',
  properties: {
    limit: {
      type: 'integer'
...
export const usecases_ServiceCardListOutputDTOSchema = {
  type: 'object',
  required: ['model', 'total_count'],
  properties: {
    model: {
...
export const usecases_ServiceCardListResponseSchema = {
  type: 'object',
  required: ['error', 'msg'],
  properties: {
    error: {
